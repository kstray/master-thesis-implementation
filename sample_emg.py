...
for i in range(2, 9):
   hackeeg.wreg(ads1299.CHnSET + i, ads1299.SHORTED | ads1299.PDn)
hackeeg.wreg(ads1299.CHnSET + 1, ads1299.ELECTRODE_INPUT | GAIN)
...
channel_offset = np.load('data/channel_offset.npy')
channel_data[1:] = channel_data[1:] - channel_offset[...,np.newaxis]
np.save('channel_data_external_bias.npy', channel_data)